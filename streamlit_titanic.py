...
# part 2: show project's result wwith Streamlit
st.title("Data Science")
st.write("## Titanic Surviaval Prediction Project")
...
if choice == 'Overview':
    ...
    st.write('Train set score: {}'.format(round(train_score)))
    ...
    fig, ax = plt.subplots()
    ax.bar(['False Negtive', 'True Negative', 'True Positive', 'False Positive'], [FN, TN,TP,FP])
    st.pyplot(fig)
    #ROC curve
    st.write('ROC curve')
